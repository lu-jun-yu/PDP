...
决定分五类：起诉（情节严重）、起诉（情节轻微）、法定不起诉、存疑不起诉、相对不起诉
- 起诉（情节严重）/ 起诉（情节轻微）/ 相对不起诉：必须列出罪名
- 法定不起诉 / 存疑不起诉：无罪名
法条和罪名使用"、"号分隔，便于提取。
"""
...
规则：
- 决定仅限五类：起诉（情节严重）、起诉（情节轻微）、相对不起诉、法定不起诉、存疑不起诉。
- 起诉（情节严重）、起诉（情节轻微）或相对不起诉时必须给出罪名；法定不起诉或存疑不起诉时罪名填"无"。
- 多个法条或罪名之间用"、"号分隔。
